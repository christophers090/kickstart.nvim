...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      local custom_files = require 'custom.functions.telescope_files'
      ...
      end, { desc = '[S]earch files in current [D]irectory' })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --
      -- - <leader>ea) - [E]dit [A]dd surround [)]Paren
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'starlark' },
